...
var ASM_CONSTS = {
 ...
 128141: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 128234: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 128303: function() {return window.innerWidth;},  
 128333: function() {return window.innerHeight;},  
 128364: function($0, $1) {alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1));}
};
