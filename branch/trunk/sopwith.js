...
var ASM_CONSTS = {
 ...
 134981: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 135074: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 135143: function() {return window.innerWidth;},  
 135173: function() {return window.innerHeight;},  
 135204: function($0, $1) {alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1));}
};
