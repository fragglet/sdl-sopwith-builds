...
var ASM_CONSTS = {
  120768: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 120905: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 ...
 128477: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 128570: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 128639: function() {return window.innerWidth;},  
 128669: function() {return window.innerHeight;},  
 128700: function($0, $1) {alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1));}
};
